...
class HomoscedasticTimeseriesModel(WindPredictionGP):
    ...
    def get_prior_gp(self, X_train=None, y_train=None):
        ...
        self.filename_gp = f'modules/gp/models/gp_prior_{self.opt["n_z"]}_homoscedastic_without_time'
        try:
    ...
    def plot_prior_distribution(self, start_time, stop_time):
        ...
        means_norm = [self.data_handler.weather_data['means'][i] for i in [
            'wind_speed_10m_sh', 'wind_speed_of_gust_diff_sh', 'sqrt_specific_convective_available_potential_energy_sh',
            'air_temperature_2m_sh', 'relative_humidity_2m_sh', 'air_pressure_at_sea_level_sh'
        ]]
        n_bins = 10
