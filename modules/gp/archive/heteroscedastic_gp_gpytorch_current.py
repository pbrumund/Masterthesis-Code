...
def get_gp(weather_data, opt):
    ...
    y_train_noise = y_train_noise.reshape((-1,))
    ...
    #         noise[i] = gp_noise(X_train[i:i+1]).mean.numpy()
    ...
    gp = HeteroscedasticGP(X_train, y_train, likelihood, gp_noise, opt)
