...
class DayAheadScheduler:
    ...
    def get_optimization_problem(self):
        ...
        P_in_gtg = ca.if_else(load>1e-4, load/eta_gtg, 0)
        # constraints
        ...
        # Cost function
        self.J = ca.sum1(P_in_gtg) + 0*ca.sumsqr(eta_gtg-self.ohps.gtg.eta_fun(1)) + 100*s_E/E_target + 0.1*ca.sumsqr(I_bat/I_bat_ub) - SOC_fin + 0.01*ca.sumsqr((P_out[1:]-P_out[:-1])/self.ohps.P_gtg_max)
