...
mpc_opt = get_mpc_opt(N=steps, use_simple_scenarios=False, std_list_multistage = std_list, dE_min=1000, max_scenarios=9)
...
plt_sc = ax_pred[0].plot(times, means, color='tab:purple', label='Scenarios without minimum energy difference')[0]
ax_pred[1].plot(times, means_P, color='tab:purple', label='Scenarios')
...
plt_sc1 = ax_pred[0].plot(times, means, color='tab:blue', label='Scenarios with minimum energy difference')[0]
