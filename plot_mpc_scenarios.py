...
mpc_opt = get_mpc_opt(N=steps, use_simple_scenarios=False, std_list_multistage = std_list, dE_min=5000, max_scenarios=9)
...
mpc_opt = get_mpc_opt(N=steps, use_simple_scenarios=True, std_list_multistage = std_list, dE_min=5000, max_scenarios=9)
multistage_mpc = MultistageMPC(ohps, gp, mpc_opt)
...
cm = 1/2.54
fig.set_size_inches(15*cm, 10*cm)
plt.savefig(f'../Abbildungen/mpc_scenarios_simple_{t_start.strftime("%d_%m_%H")}.pgf', bbox_inches='tight')
