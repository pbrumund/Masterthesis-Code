...
from modules.gp import HomoscedasticTimeseriesModel, TimeseriesModel, get_gp_opt
...
xlabels = ['Mean wind speed (m/s)', 'Difference of gust and mean wind speed (m/s)', r'$\sqrt{CAPE}$ ($\sqrt{\mathrm{J/kg}}$)', 'Temperature (k)', 
...
gp = HomoscedasticTimeseriesModel(gp_opt)
...
plt.savefig('../Abbildungen/prior_gp_homoscedastic_marginal.pgf', bbox_inches='tight')
plt.show()