...
mpc_opt = get_mpc_opt(N=30, std_list_multistage=std_list, use_simple_scenarios=True, dE_min=5000)#,  t_start=datetime.datetime(2022,12,6), t_end=datetime.datetime(2022,12,8))
